-- ========================================
-- USER ACTIVITIES DATABASE SCHEMA
-- ACID-compliant schema for user carts, favorites, orders, and search history
-- ========================================
...
CREATE TABLE IF NOT EXISTS user_carts (
  ...
  -- Unique constraint: one cart entry per product/size/color combination
...
CREATE TABLE IF NOT EXISTS user_favorites (
  ...
  user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
  product_id INTEGER NOT NULL,
  product_data JSONB NOT NULL, -- Store complete product data for consistency
  created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  
  -- Unique constraint: one favorite entry per product
  UNIQUE(user_id, product_id)
);

-- Index for fast user favorites lookups
...
CREATE TABLE IF NOT EXISTS search_history (
  ...
  filters_applied JSONB, -- Store applied filters
  created_at TIMESTAMPTZ NOT NULL DEFAULT NOW()
);

-- Index for fast search history lookups
...
-- ========================================
-- 7. FUNCTION TO TRACK ORDER STATUS CHANGES
-- ========================================
...
-- ========================================
-- 9. HELPER FUNCTIONS FOR CART OPERATIONS
-- ========================================
...
-- ========================================
-- 10. FUNCTION TO GENERATE ORDER NUMBER
-- ========================================
...
DECLARE
  ...
  counter INTEGER;
BEGIN
  -- Generate order number: JB-YYYYMMDD-XXXX
...
-- ========================================
-- 11. FUNCTION TO CREATE ORDER FROM CART
-- ========================================
...
BEGIN
  ...
  -- Calculate shipping (example: free over $50, else $10)
