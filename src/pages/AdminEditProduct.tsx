...
import { Plus, Upload, X, Eye, Save, RefreshCw, ExternalLink, ArrowLeft } from 'lucide-react';
...
const AdminEditProduct = () => {
  ...
  useEffect(() => {
    if (productToEdit) {
      setFormData({
        ...
        rating: productToEdit.rating || 4.0,
        reviews: productToEdit.reviews || 0,
        careInstructions: productToEdit.careInstructions || '',
        origin: productToEdit.origin || 'Made in India',
        sku: productToEdit.sku || ''
      });

      // Load existing images
      if (productToEdit.images && productToEdit.images.length > 0) {
        setImagePreview(productToEdit.images);
      }
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Update product using the context
    updateProduct(parseInt(id || '0'), formData);
    
    // Show success message
    toast.success(`Product "${formData.name}" updated successfully!`);
    
    // Navigate back to manage products
    navigate('/admin/manage-products');
  };
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h1 className="font-heading text-3xl font-bold mb-2">Edit Product</h1>
